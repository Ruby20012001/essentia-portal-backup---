    ...
    return (
      <div className="rounded-lg border border-line bg-card px-6 py-16 text-center">
        ...
        <p className="mx-auto mt-1 max-w-lg font-body text-sm font-light text-muted">
          The question bank is HR&apos;s. The questions for a round you are
          sitting in appear on the round itself.
        </p>
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="mb-6 mt-4">
        ...
        <p className="font-body text-sm font-light text-muted">
          A set belongs to a stage, or a seat, or both. When a round is
          scheduled the most specific set is chosen for it, so nobody has to
          remember.
        </p>
      </div>
